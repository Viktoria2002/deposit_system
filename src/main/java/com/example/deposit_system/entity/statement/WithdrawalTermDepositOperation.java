...
@Component
public class WithdrawalTermDepositOperation implements TermDepositOperation {
    private TermDepositOperationService termDepositOperationService;
    private OpenedTermDepositService openedTermDepositService;

    public WithdrawalTermDepositOperation(@Lazy TermDepositOperationService termDepositOperationService, OpenedTermDepositService openedTermDepositService) {
