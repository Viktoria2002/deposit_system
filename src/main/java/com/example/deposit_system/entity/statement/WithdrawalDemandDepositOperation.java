...
@Component
public class WithdrawalDemandDepositOperation implements DemandDepositOperation {
    ...
    public WithdrawalDemandDepositOperation(@Lazy DemandDepositOperationService demandDepositOperationService, OpenedDemandDepositService openedDemandDepositService) {
